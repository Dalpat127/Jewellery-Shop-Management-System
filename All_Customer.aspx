<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="All_Customer.aspx.cs" Inherits="All_Customer" %>
        ...
        <table class="style1" 
            ...
            <tr>
                <td class="style7">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Search:</td>
                <td class="style8">
                    <asp:RadioButton ID="RadioButton1" runat="server" GroupName="abc" Text="By Customer ID" 
                CssClass="style6" />
                    <span class="style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
